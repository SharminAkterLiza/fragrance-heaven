            ...
            <div className="drawer-side -ml-10 ">
                ...
                <ul className="menu p-4 w-60 min-h-full  mt-2 bg-orange-400 ">
                  
                  {
                    ...
                    <li><NavLink to="/dashboard/addItem"> <GiForkKnifeSpoon /> Add Products</NavLink></li>
                    <li><NavLink to="/dashboard/manageItems"> <FaWallet></FaWallet> Manage Products</NavLink></li>
